...
//extern SPI_HandleTypeDef SD_SPI_HANDLE; // TODO uncommment once I figure out how to link definition of SD_SPI_HANDLE in main.c
//SPI_HandleTypeDef SD_SPI_HANDLE;
// NOTE: 3/4/23 - I replaced all instances of SD_SPI_HANDLE with hspi2 in this file due to errors in conflict
// with the declaration of hspi2 in spi.c. This is only a temporary workaround.
